...
public class GremlinWheel extends AbstractImageEvent {
    private static final Logger logger = LogManager.getLogger(GremlinWheel.class.getName());
    public static final String ID = "rorgmod:Wheel of Change";
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);
    public static final String NAME = eventStrings.NAME;
    public static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    public static final String[] OPTIONS = eventStrings.OPTIONS;
    public static final String INTRO_DIALOG = DESCRIPTIONS[0];
    private GremlinWheel.CUR_SCREEN screen;
    private int result;
    ...
    public GremlinWheel() {
        ...
        this.screen = GremlinWheel.CUR_SCREEN.INTRO;
...
//        RorgMod.logger.info("BUTTON PRESSED: WHEEL EVENT");
        RorgMod.logger.info(this.screen);
        RorgMod.logger.info(buttonPressed);
        switch(this.screen) {
            case INTRO:
    ...
    public void update() {
        ...
        if (this.startSpin && this.bounceTimer == 0.0F && this.buttonPressed) {
            ...
            if (this.animTimer > 0.0F) {
                ...
                this.screen = GremlinWheel.CUR_SCREEN.COMPLETE;
            }
        }
    ...
    public void reopen() {
        if ((this.screen != GremlinWheel.CUR_SCREEN.LEAVE) && (this.screen != GremlinWheel.CUR_SCREEN.FIGHT)) {
    ...
    private void applyResult() {
        switch(this.result) {
            case 0:
                this.hasFocus = false;
                logMetricGainGold(this.ID, "Gold", this.goldAmount);
                break;
            case 1:
                AbstractDungeon.getCurrRoom().rewards.clear();
                ...
                logMetric(this.ID, "Relic");
                this.hasFocus = false;
                break;
            case 2:
                logMetricHeal(this.ID, "Full Heal", AbstractDungeon.player.maxHealth - AbstractDungeon.player.currentHealth);
                AbstractDungeon.player.heal(AbstractDungeon.player.maxHealth);
                this.hasFocus = false;
                break;
            case 3:
                AbstractCard curse = new Decay();
                logMetricObtainCard(this.ID, "Cursed", curse);
            ...
            default:
                ...
                logMetricTakeDamage(this.ID, "Damaged", damageAmount);
        }
    ...
    private void purgeLogic() {
        if (this.purgeResult && !AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
            ...
            logMetricCardRemoval(this.ID, "Card Removal", c);
