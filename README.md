...
* **Beta Cards**: Cards labeled as **(ACTIVATE IN CONFIG)** needs "Beta Cards" checked in the Mod Config before restarting to appear. they may be less balanced/clunky than other cards.
...
* **Nemesis** (Planned for 1.3)
* **Snake Plant** (Planned for 1.3)
